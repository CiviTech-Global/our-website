...
-- CreateIndex
CREATE INDEX "businesses_status_state_idx" ON "businesses"("status", "state");
...
-- CreateIndex
CREATE INDEX "products_status_state_created_at_idx" ON "products"("status", "state", "created_at");

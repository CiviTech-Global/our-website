...
const SCHENGEN_CEILINGS = [
  { value: '30000', label: '۳۰٬۰۰۰ یورو (حداقل شینگن)', labelEn: '€30,000 (Schengen minimum)' },
...
export const travelProducts: ProductDef[] = [
  {
    ...
    sourceUrl: 'https://www.azki.com/personal-insurance/travel-insurance',
    intake: 'SELF_SERVE',
    audience: 'INDIVIDUAL',
    icon: 'Plane',
    order: 1,
    fields: [
      {
        ...
        required: true,
        options: [
          { value: 'schengen', label: 'اروپا / شینگن', labelEn: 'Europe / Schengen' },
          ...
          { value: 'worldwide', label: 'چند مقصد / سراسر جهان', labelEn: 'Multiple / worldwide' },
        ],
      },
      {
      ...
      peopleCount({ label: 'تعداد مسافران', labelEn: 'Number of travellers', max: 50 }),
      {
        name: 'ageBand',
...

  {
    ...
    sourceUrl: 'https://www.azki.com/nano-product/internal-travel-insurance',
    intake: 'SELF_SERVE',
    audience: 'INDIVIDUAL',
    icon: 'MapPin',
    order: 2,
    fields: [
      peopleCount({ label: 'تعداد نفرات', labelEn: 'Number of travellers', max: 500 }),
...

  {
    ...
    sourceUrl: 'https://www.azki.com/nano-product/pilgrims-insurance',
    intake: 'SELF_SERVE',
    audience: 'INDIVIDUAL',
    icon: 'Compass',
    order: 3,
    fields: [
      peopleCount({ label: 'تعداد زائران', labelEn: 'Number of pilgrims', max: 200 }),
      durationDays({ label: 'مدت اقامت', labelEn: 'Length of stay', min: 8, max: 31 }),
      startDate({ label: 'تاریخ شروع سفر', labelEn: 'Departure date' }),
      {
        name: 'returnDate',
        label: 'تاریخ بازگشت',
...

  {
    ...
    sourceUrl: 'https://www.azki.com/nano-product/incoming-travel-insurance',
    intake: 'SELF_SERVE',
    audience: 'INDIVIDUAL',
    icon: 'PlaneLanding',
    order: 4,
    fields: [
      ...
      durationDays({ label: 'مدت اقامت در ایران', labelEn: 'Length of stay in Iran', max: 92 }),

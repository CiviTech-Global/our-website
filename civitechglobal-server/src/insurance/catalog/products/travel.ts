...
import { coverageCeiling, durationDays, peopleCount, startDate } from '../fields.js';
...
export const travelProducts: ProductDef[] = [
  {
    ...
    premiumFactors: ['سن مسافر', 'مدت سفر', 'تعداد کشورهای مقصد', 'سقف تعهدات انتخابی'],
    faq: [
      {
      ...
      },
      {
        ...
        answer: 'حداکثر ۹۲ روز متوالی؛ طرح‌های شش‌ماهه و یک‌ساله نیز وجود دارد.',
      },
      {
    ...
    keyFacts: [
      { label: 'ویزای شینگن', value: 'ارائهٔ بیمه‌نامه الزامی است' },
      { label: 'حداکثر مدت', value: '۹۲ روز متوالی؛ طرح شش‌ماهه و یک‌ساله نیز وجود دارد' },
      { label: 'شروع اعتبار', value: 'از زمان درج مهر خروج بر گذرنامه' },
      { label: 'گروه‌های سنی', value: 'از زیر ۱۲ سال تا بالای ۸۰ سال' },
      { label: 'استرداد', value: 'در شش ماه نخست پس از خرید' },
      { label: 'بیماری‌های سابقه‌دار', value: 'پوشش داده نمی‌شود' },
    ],
    claimSteps: [
      'پیش از هر اقدام درمانی با شمارهٔ امداد مندرج در بیمه‌نامه تماس بگیرید.',
      'اصل صورتحساب‌ها و گزارش پزشک را در کشور مقصد نگه دارید.',
      'اصل بیمه‌نامه و تصویر صفحات گذرنامه با مهر خروج و ورود را آماده کنید.',
      'پس از بازگشت، مدارک را برای بررسی به شرکت بیمه تحویل دهید.',
    ],
    intake: 'SELF_SERVE',
    audience: 'INDIVIDUAL',
    icon: 'Plane',
...

  {
    ...
    coverages: ['غرامت فوت', 'نقص عضو', 'ازکارافتادگی دائم و موقت', 'هزینه‌های پزشکی'],
    exclusions: [
      'خسارت ناشی از سهل‌انگاری یا بی‌احتیاطی خود مسافر',
      'حوادثی که قصد و ارادهٔ فرد در آن دخیل باشد',
    ],
    premiumFactors: ['مدت سفر', 'سرمایهٔ انتخابی', 'تعداد افراد بیمه‌شده', 'پوشش‌های اضافی'],
    faq: [
      {
    ...
    keyFacts: [
      {
        label: 'نوع بیمه‌نامه',
        value: 'بیمهٔ حوادث انفرادی یا گروهی، نه بیمهٔ مسافرتی بین‌المللی',
      },
      { label: 'مناسب برای', value: 'تورها و سفرهای گروهی داخلی' },
      { label: 'سرمایه', value: 'به انتخاب بیمه‌گذار تعیین می‌شود' },
    ],
    intake: 'SELF_SERVE',
    audience: 'INDIVIDUAL',
    icon: 'MapPin',
...

  {
    ...
    summaryEn: 'For pilgrimage to Iraq — supplements the compulsory Samah cover',
    description:
    ...
    faq: [
      {
        ...
        answer: 'خیر. این بیمه‌نامه تکمیل‌کنندهٔ بیمهٔ سماح است؛ سماح باید جداگانه تهیه شود.',
      },
      {
      ...
      },
      {
        ...
        answer: 'حدود ۱۲ ساعت پیش از پرواز، و برای سفرهای زمینی از ساعت صفر بامداد روز حرکت.',
      },
    ],
    keyFacts: [
      { label: 'نسبت با بیمهٔ سماح', value: 'تکمیلی؛ جایگزین سماح نیست' },
      { label: 'حداکثر مدت', value: 'حدود ۳۰ تا ۳۱ روز' },
      { label: 'شروع پوشش', value: 'حدود ۱۲ ساعت پیش از پرواز؛ در سفر زمینی از بامداد حرکت' },
      { label: 'محدودهٔ جغرافیایی', value: 'کشور عراق' },
      { label: 'زمان خرید', value: 'در تمام ایام سال، نه فقط اربعین' },
    ],
    claimSteps: [
      'حادثه یا بیماری را در اولین فرصت به شرکت بیمه اطلاع دهید.',
      'مستندات پزشکی و بیمارستانی و گواهی پزشک معالج را نگه دارید.',
      'تصویر صفحات گذرنامه با مهر مرزی و مانیفست کاروان را آماده کنید.',
      'کد رهگیری سامانهٔ سماح را ضمیمهٔ پرونده کنید.',
      'در صورت فوت، گواهی فوت و گزارش پزشکی قانونی لازم است.',
    ],
    intake: 'SELF_SERVE',
    audience: 'INDIVIDUAL',
    icon: 'Compass',
...

  {
    ...
    keyFacts: [
      { label: 'مدت اعتبار', value: '۱ تا ۹۲ روز' },
      { label: 'ابطال', value: 'پس از ورود به ایران ممکن نیست' },
      { label: 'استرداد', value: 'پیش از سفر، با کسر مبلغی' },
      { label: 'مهلت اعلام حادثه', value: 'پنج روز' },
      { label: 'رسیدگی', value: 'حدود پنج روز کاری پس از دریافت مدارک' },
    ],
    claimSteps: [
      'با مرکز امداد شرکت بیمه تماس بگیرید تا انتقال و پذیرش انجام شود.',
      'نام و شمارهٔ بیمه‌نامه و گذرنامه را در اختیار بگذارید.',
      'نشانی و شمارهٔ تماس محل اقامت در ایران را اعلام کنید.',
      'شرح حادثه یا بیماری و مدارک درمانی را ارائه دهید.',
    ],
    intake: 'SELF_SERVE',
    audience: 'INDIVIDUAL',
    icon: 'PlaneLanding',

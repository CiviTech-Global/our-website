...
export const lifeProducts: ProductDef[] = [
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer: 'سرمایهٔ فوت و اندوخته از مالیات بر درآمد و مالیات بر ارث معاف است.',
      },
      {
      ...
      },
      {
        ...
        answer: 'بله، بازخرید اندوخته در هر زمان از مدت قرارداد امکان‌پذیر است.',
      },
    ],
    keyFacts: [
      { label: 'مدت قرارداد', value: '۵ تا ۳۰ سال' },
      { label: 'محدودهٔ سنی', value: 'معمولاً تا ۵۰ سالگی؛ مجموع سن و مدت قرارداد حداکثر ۷۰' },
      { label: 'سرمایهٔ فوت', value: 'چند برابر حق بیمهٔ سالانه، به انتخاب بیمه‌گذار' },
      { label: 'وام', value: 'تا حدود ۹۰٪ اندوخته، بدون ضامن، بازپرداخت تا ۳۶ قسط' },
      { label: 'بازخرید', value: 'در هر زمان از مدت قرارداد' },
      { label: 'مالیات', value: 'سرمایهٔ فوت و اندوخته از مالیات بر درآمد و ارث معاف است' },
      { label: 'دورهٔ انتظار خودکشی', value: 'معمولاً دو سال نخست' },
    ],
    claimSteps: [
      'فوت یا حادثه را در اولین فرصت به شرکت بیمه اطلاع دهید.',
      'گواهی فوت و گزارش پزشکی قانونی دربارهٔ علت فوت را تهیه کنید.',
      'مدارک هویتی بیمه‌شده و ذی‌نفعان و در صورت لزوم گواهی انحصار وراثت را ارائه دهید.',
      'اصل بیمه‌نامه و آخرین رسیدهای پرداخت حق بیمه را ضمیمه کنید.',
      'برای بیماری‌های خاص یا ازکارافتادگی، مدارک و گزارش پزشک معالج لازم است.',
    ],
    intake: 'SELF_SERVE',
    audience: 'INDIVIDUAL',
    icon: 'Sprout',
    ...
    fields: [
      ...
      currencyField('monthlyPremium', 'حق بیمه ماهانه', 'Monthly premium', {
        ...
        helpEn: 'What you can set aside each month — the single biggest driver of the final fund.',
      }),
      {
        name: 'termYears',
        label: 'مدت قرارداد',
...

  {
    ...
    fields: [
      ...
      currencyField('monthlyPremium', 'حق بیمه ماهانه مورد نظر', 'Intended monthly premium', {
        required: false,
      }),
      currencyField('targetPension', 'مستمری ماهانه هدف', 'Target monthly pension', {
        required: false,
...

  {
    ...
    fields: [
      age(),
      {
        ...
        helpEn: 'Occupational risk is the largest factor in this plan’s premium.',
      },
      currencyField(
        'targetPension',
...

  {
    ...
    fields: [
      ...
      currencyField('sumInsuredPerPerson', 'سرمایه فوت هر نفر', 'Sum insured per person', {
        required: false,
      }),
    ],
  },

...
const LIFE_COVERS = [
  ...
  { value: 'death-accident', label: 'فوت بر اثر حادثه', labelEn: 'Accidental death' },
  { value: 'critical-illness', label: 'بیماری‌های خاص', labelEn: 'Critical illness' },
  { value: 'disability', label: 'نقص عضو و ازکارافتادگی', labelEn: 'Disability' },
...
export const lifeProducts: ProductDef[] = [
  {
    ...
    order: 1,
    fields: [
      age({ label: 'سن بیمه‌گذار', labelEn: 'Age of the policyholder', max: 50 }),
...

  {
    ...
    fields: [
      ...
      currencyField('monthlyPremium', 'حق بیمه ماهانه مورد نظر', 'Intended monthly premium', { required: false }),
...

  {
    ...
    fields: [
      ...
      currencyField('targetPension', 'مستمری ماهانه مورد نظر بازماندگان', 'Intended monthly pension for survivors', {
        required: false,
      }),
      {
        name: 'dependants',
...

  {
    ...
    order: 4,
    fields: [
      peopleCount({ label: 'تعداد کارکنان', labelEn: 'Number of employees', min: 5 }),
      {
        name: 'averageAge',
      ...
      currencyField('sumInsuredPerPerson', 'سرمایه فوت هر نفر', 'Sum insured per person', { required: false }),
    ],
  },
...

  {
    ...
    fields: [
      ...
      peopleCount({ label: 'تعداد نیروهای پروژه', labelEn: 'Project headcount' }),
      {
        name: 'projectMonths',
        label: 'مدت پروژه',

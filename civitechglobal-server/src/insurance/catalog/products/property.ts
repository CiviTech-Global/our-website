...
const ADDON_PERILS = [
  ...
  { value: 'water-damage', label: 'ترکیدگی لوله آب', labelEn: 'Burst water pipes' },
...
export const propertyProducts: ProductDef[] = [
  {
    ...
    sourceUrl: 'https://www.azki.com/property-insurance/fire-insurance',
    intake: 'SELF_SERVE',
    audience: 'INDIVIDUAL',
    icon: 'Flame',
    order: 1,
    fields: [
      ...
      structureType(),
      buildingAge(),
      unitCount({ required: false, help: 'برای ساختمان‌های چندواحدی', helpEn: 'For multi-unit buildings' }),
      currencyField('constructionCostPerMeter', 'هزینه ساخت هر متر مربع', 'Construction cost per m²', {
        ...
        helpEn: 'Used to value the structure. An estimate is fine; our specialist will refine it.',
      }),
...

  {
    ...
    sourceUrl: 'https://www.azki.com/property-insurance/earthquake-insurance',
    intake: 'SELF_SERVE',
    audience: 'INDIVIDUAL',
    icon: 'Activity',
    order: 2,
...

  {
    ...
    sourceUrl: 'https://www.azki.com/nano-product/elevator',
    intake: 'SELF_SERVE',
    audience: 'INDIVIDUAL',
    icon: 'ArrowUpDown',
    order: 3,
...

  {
    ...
    sourceUrl: 'https://www.azki.com/nano-product/comprehensive-home-insurance',
    intake: 'CALLBACK',
    audience: 'INDIVIDUAL',
    icon: 'Building',
    order: 4,
...

  {
    ...
    sourceUrl: 'https://www.azki.com/nano-product/business-fire',
    intake: 'CALLBACK',
    audience: 'CORPORATE',
    icon: 'Store',
    order: 5,
    fields: [
      ...
      propertyCity(),
      {
        ...
        options: [
          ...
          { value: 'retail', label: 'مغازه / فروشگاه', labelEn: 'Shop / retail' },
      ...
      area(),
      currencyField('buildingValue', 'ارزش تقریبی بنا و تأسیسات', 'Approximate value of building and fittings', {
        required: false,
      }),
      currencyField('stockValue', 'ارزش تقریبی کالا و موجودی', 'Approximate value of stock', { required: false }),
    ],
  },

  {
    ...
    notes: ['ارائه فرم پیشنهاد و مدارک هویتی الزامی است.', 'بازدید کارشناس در اغلب موارد ضروری است.'],
    sourceUrl: 'https://www.azki.com/nano-product/industrial-fire-insurance',
    intake: 'CALLBACK',
    audience: 'CORPORATE',
    icon: 'Factory',
    order: 6,
    fields: [
      ...
      currencyField('buildingValue', 'ارزش بنا و تأسیسات', 'Value of building and installations', { required: false }),
      currencyField('machineryValue', 'ارزش ماشین‌آلات', 'Value of machinery', { required: false }),
      currencyField('stockValue', 'ارزش موجودی انبار', 'Value of stock', { required: false }),
      {
        name: 'addonPerils',
        ...
        required: false,
        options: [
          { value: 'earthquake', label: 'زلزله و رانش زمین', labelEn: 'Earthquake and landslide' },
          { value: 'flood', label: 'سیل و طغیان', labelEn: 'Flood' },
          { value: 'storm', label: 'طوفان و بارش شدید', labelEn: 'Storm and heavy rain' },
          { value: 'gas-leak', label: 'نشت گاز', labelEn: 'Gas leak' },
          { value: 'neighbour-liability', label: 'مسئولیت در قبال همسایگان', labelEn: 'Liability to neighbours' },
        ],
      },
    ],
  },

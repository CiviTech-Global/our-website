...
export const propertyProducts: ProductDef[] = [
  {
    ...
    summaryEn: 'Protects the building and its contents against fire, explosion and lightning',
    description:
    ...
    optionalCoverages: ['زلزله', 'طوفان', 'سیل', 'ترکیدگی لوله آب', 'سرقت', 'نوسانات برق', 'جنگ'],
    notes: [
    ...
    keyFacts: [
      ...
      { label: 'مناسب برای', value: 'مالک و مستأجر؛ مستأجر فقط اموال را بیمه می‌کند' },
      { label: 'سند مالکیت', value: 'لازم نیست' },
      { label: 'بازدید اولیه', value: 'برای برخی پوشش‌های اضافی الزامی است' },
      { label: 'فهرست اثاثیه', value: 'برای سرمایهٔ بیش از یک میلیارد تومان لازم است' },
    ],
    claimSteps: [
      'در صورت آتش‌سوزی با آتش‌نشانی تماس بگیرید و گزارش رسمی بگیرید.',
      'پیش از جابه‌جایی، از محل و اموال آسیب‌دیده عکس و فیلم تهیه کنید.',
      'خسارت را به شرکت بیمه اعلام و فرم خسارت را تکمیل کنید.',
      'فهرست اموال آسیب‌دیده و سالم را به‌تفکیک آماده کنید.',
      'گزارش آتش‌نشانی و نیروی انتظامی را ضمیمه و منتظر بازدید کارشناس بمانید.',
    ],
    intake: 'SELF_SERVE',
    audience: 'INDIVIDUAL',
    icon: 'Flame',
    ...
    fields: [
      ...
      currencyField('contentsValue', 'ارزش اثاثیه و لوازم منزل', 'Value of contents', {
...

  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer: 'بله؛ مستأجر برای بیمه‌کردن اموال خود به اجازهٔ مالک نیاز ندارد.',
      },
      {
    ...
    keyFacts: [
      { label: 'نوع پوشش', value: 'پوشش اضافی روی بیمه‌نامهٔ آتش‌سوزی' },
      { label: 'مهلت اعلام خسارت', value: 'پنج روز کاری' },
      { label: 'سند مالکیت', value: 'لازم نیست' },
      { label: 'مستأجر', value: 'بدون اجازهٔ مالک می‌تواند اموال خود را بیمه کند' },
      { label: 'خسارت جانی', value: 'پوشش داده نمی‌شود' },
    ],
    claimSteps: [
      'ظرف پنج روز کاری خسارت را به شرکت بیمه اعلام کنید.',
      'از محل و اموال آسیب‌دیده عکس و فیلم بگیرید.',
      'گزارش مؤسسهٔ ژئوفیزیک و تأییدیهٔ فرمانداری یا بخشداری را تهیه کنید.',
      'فهرست و ارزش اموال آسیب‌دیده را ارائه دهید.',
      'در صورت اعتراض به مبلغ خسارت، موضوع در شورای حل اختلاف قابل پیگیری است.',
    ],
    intake: 'SELF_SERVE',
    audience: 'INDIVIDUAL',
    icon: 'Activity',
...

  {
    ...
    faq: [
      {
        ...
        answer: 'مدیریت ساختمان بیمه‌نامه را تهیه می‌کند و هزینهٔ آن میان واحدها تقسیم می‌شود.',
      },
      {
        question: 'سقف هزینهٔ پزشکی چقدر است؟',
        answer: 'قابل انتخاب است و معمولاً از ۵ تا ۴۰ میلیون تومان تعیین می‌شود.',
      },
      {
    ...
    keyFacts: [
      { label: 'خریدار بیمه‌نامه', value: 'مدیریت ساختمان' },
      { label: 'سقف هزینهٔ پزشکی', value: 'قابل انتخاب، حدود ۵ تا ۴۰ میلیون تومان' },
      { label: 'غرامت فوت و نقص عضو', value: 'بر مبنای نرخ دیهٔ سال' },
      { label: 'شرط اصلی پرداخت', value: 'انجام منظم سرویس دوره‌ای توسط شرکت مجاز' },
      { label: 'خسارت مالی', value: 'فقط در آسانسورهای باری' },
    ],
    claimSteps: [
      'به مصدوم رسیدگی و در صورت نیاز با اورژانس تماس بگیرید.',
      'حادثه را به شرکت بیمه اعلام کنید.',
      'قرارداد و فاکتورهای سرویس دوره‌ای و گواهی بازرسی فنی را ارائه دهید.',
      'مدارک درمانی مصدوم و گزارش مقامات ذی‌صلاح را ضمیمه کنید.',
    ],
    intake: 'SELF_SERVE',
    audience: 'INDIVIDUAL',
    icon: 'ArrowUpDown',
...

  {
    ...
    requiredDocuments: ['اطلاعات هویتی مالک یا مدیر ساختمان', 'کد پستی ساختمان'],
    keyFacts: [
      { label: 'ترکیب پوشش', value: 'آسانسور، مسئولیت مدیران ساختمان و آتش‌سوزی در یک بیمه‌نامه' },
      { label: 'خریدار بیمه‌نامه', value: 'مدیریت ساختمان' },
      { label: 'صدور', value: 'به‌صورت آنلاین و بدون بازدید اولیه' },
    ],
    intake: 'CALLBACK',
    audience: 'INDIVIDUAL',
    icon: 'Building',
...

  {
    ...
    keyFacts: [
      { label: 'موضوع بیمه', value: 'فروشگاه، اداره، مرکز خرید و انبار' },
      { label: 'خطرهای اصلی', value: 'آتش‌سوزی، صاعقه و انفجار' },
      { label: 'بیمه‌نامهٔ شناور', value: 'برای انبارهایی با موجودی متغیر، با تسویهٔ پایان دوره' },
      { label: 'مرهونات بانکی', value: 'بانک به‌عنوان ذی‌نفع در بیمه‌نامه درج می‌شود' },
    ],
    intake: 'CALLBACK',
    audience: 'CORPORATE',
    icon: 'Store',
    ...
    fields: [
      ...
      currencyField('stockValue', 'ارزش تقریبی کالا و موجودی', 'Approximate value of stock', {
        required: false,
      }),
    ],
  },

  {
    ...
    keyFacts: [
      { label: 'موضوع بیمه', value: 'ساختمان، ماشین‌آلات، تأسیسات، مواد اولیه و موجودی انبار' },
      { label: 'خطرهای اصلی', value: 'آتش‌سوزی، صاعقه و انفجار' },
      { label: 'اعلام خسارت', value: 'در اسرع وقت و به‌صورت کتبی' },
      { label: 'نوع بیمه‌نامه', value: 'سرمایهٔ ثابت یا شناور (اظهارنامه‌ای)' },
    ],
    claimSteps: [
      'در اسرع وقت و به‌صورت کتبی خسارت را به شرکت بیمه اعلام کنید.',
      'گزارش آتش‌نشانی و نیروی انتظامی را تهیه کنید.',
      'فهرست اموال آسیب‌دیده را به‌تفکیک و با ارزش تنظیم کنید.',
      'بیمه‌نامه، رسید حق بیمه و سند مالکیت یا اجاره‌نامه را ارائه دهید.',
      'محل را برای بازدید کارشناسان در دسترس نگه دارید.',
    ],
    intake: 'CALLBACK',
    audience: 'CORPORATE',
    icon: 'Factory',
    ...
    fields: [
      ...
      currencyField('buildingValue', 'ارزش بنا و تأسیسات', 'Value of building and installations', {
        required: false,
      }),

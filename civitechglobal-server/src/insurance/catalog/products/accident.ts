...
export const accidentProducts: ProductDef[] = [
  {
    ...
    coverages: ['فوت ناشی از حادثه', 'نقص عضو کلی و جزئی', 'ازکارافتادگی کامل دائم'],
    optionalCoverages: [
    ...
    faq: [
      {
        ...
        answer: 'بله. پوشش ۲۴ ساعته است و در داخل و خارج از کشور برقرار می‌ماند.',
      },
      {
    ...
    keyFacts: [
      { label: 'محدودهٔ سنی', value: '۱۲ تا ۷۵ سال' },
      { label: 'محدودهٔ پوشش', value: '۲۴ ساعته، در داخل و خارج از کشور' },
      { label: 'گروه‌های شغلی', value: 'پنج طبقه، از کم‌خطر تا پرخطر' },
      { label: 'مهلت اعلام خسارت', value: 'حداکثر پنج روز' },
      { label: 'مدت بیمه‌نامه', value: 'یک‌ساله' },
    ],
    claimSteps: [
      'حادثه را حداکثر ظرف پنج روز به شرکت بیمه اعلام کنید.',
      'گواهی پزشک معالج و مدارک بیمارستان را تهیه کنید.',
      'در صورت لزوم گزارش نیروی انتظامی را ضمیمه کنید.',
      'فاکتورهای رسمی درمانی را برای جبران هزینه‌ها ارائه دهید.',
      'برای غرامت فوت، گواهی فوت و مدارک ذی‌نفعان لازم است.',
    ],
    intake: 'SELF_SERVE',
    audience: 'INDIVIDUAL',
    icon: 'Siren',
    ...
    fields: [
      ...
      currencyField('medicalSumInsured', 'سقف هزینه‌های پزشکی', 'Medical expenses limit', {
        required: false,
      }),
      {
        name: 'optionalCovers',
...

  {
    ...
    coverages: ['غرامت فوت (۱۰۰٪ سرمایه بیمه)', 'نقص عضو یا ازکارافتادگی دائم', 'هزینه‌های پزشکی'],
    notes: [
    ...
    premiumFactors: ['تعداد نفرات بیمه‌شده', 'مدت بیمه‌نامه', 'گروه شغلی', 'میانگین سنی گروه'],
    faq: [
      {
    ...
    keyFacts: [
      { label: 'حداقل تعداد', value: 'از حدود ۱۰ نفر' },
      { label: 'حداکثر سن', value: '۷۵ سال' },
      { label: 'مهلت اعلام', value: '۱۵ روز برای حادثه، ۳۰ روز برای فوت' },
      { label: 'فرانشیز', value: 'حدود ۱۰٪' },
      { label: 'مدت بیمه‌نامه', value: 'معمولاً یک‌ساله' },
      { label: 'رسیدگی به مدارک', value: 'حداکثر حدود ۳۰ روز' },
    ],
    claimSteps: [
      'بیمه‌گذار حادثه را در مهلت مقرر به شرکت بیمه اعلام می‌کند.',
      'گزارش حادثه و مدارک شناسایی فرد آسیب‌دیده تهیه می‌شود.',
      'برای نقص عضو، رادیوگرافی و گواهی پزشک معالج ضمیمه می‌شود.',
      'برای فوت، گواهی فوت، گزارش پزشکی قانونی و گواهی انحصار وراثت لازم است.',
      'پس از بررسی و در صورت نیاز معاینهٔ پزشکی، غرامت پرداخت می‌شود.',
    ],
    intake: 'SELF_SERVE',
    audience: 'CORPORATE',
    icon: 'UsersRound',
    ...
    fields: [
      ...
      currencyField('deathSumInsured', 'سرمایه فوت هر نفر', 'Death benefit per person'),
      currencyField('medicalSumInsured', 'سقف هزینه پزشکی هر نفر', 'Medical limit per person', {
        required: false,
      }),
    ],
  },

...
import { birthDate, currencyField, gender, jobRiskGroup, nationalId, peopleCount } from '../fields.js';
...
export const accidentProducts: ProductDef[] = [
  {
    ...
    sourceUrl: 'https://www.azki.com/nano-product/individual-event',
    intake: 'SELF_SERVE',
    audience: 'INDIVIDUAL',
    icon: 'Siren',
    order: 1,
    fields: [
      nationalId({ help: 'کد ملی فرد بیمه‌شده', helpEn: 'National ID of the insured person' }),
      birthDate({ help: 'محدوده سنی مجاز: ۱۲ تا ۷۵ سال', helpEn: 'Eligible ages: 12 to 75' }),
      gender(),
      jobRiskGroup(),
      {
        name: 'occupation',
      ...
      currencyField('deathSumInsured', 'سرمایه فوت و نقص عضو', 'Sum insured for death and dismemberment'),
      currencyField('medicalSumInsured', 'سقف هزینه‌های پزشکی', 'Medical expenses limit', { required: false }),
      {
        name: 'optionalCovers',
        ...
        required: false,
        options: [
          { value: 'daily-allowance', label: 'غرامت روزانه', labelEn: 'Daily allowance' },
          { value: 'hospitalisation', label: 'بستری در بیمارستان', labelEn: 'Hospitalisation' },
          { value: 'natural-disaster', label: 'بلایای طبیعی', labelEn: 'Natural disasters' },
          { value: 'hazardous-sport', label: 'فعالیت‌های ورزشی پرخطر', labelEn: 'Hazardous sports' },
        ],
      },
    ],
  },

  {
    ...
    sourceUrl: 'https://www.azki.com/nano-product/group-events',
    intake: 'SELF_SERVE',
    audience: 'CORPORATE',
    icon: 'UsersRound',
    order: 2,
    fields: [
      peopleCount({ label: 'تعداد نفرات تحت پوشش', labelEn: 'People to be covered', min: 5 }),
      {
        name: 'averageAge',
      ...
      jobRiskGroup({ label: 'دسته‌بندی شغلی بیمه‌شدگان', labelEn: 'Occupational class of the insured' }),
      {
        name: 'termMonths',
        label: 'مدت بیمه‌نامه',
        labelEn: 'Policy term',
      ...
      currencyField('medicalSumInsured', 'سقف هزینه پزشکی هر نفر', 'Medical limit per person', { required: false }),
    ],
  },
];

...
export const autoProducts: ProductDef[] = [
  {
    ...
    keyFacts: [
      { label: 'اجباری بودن', value: 'اجباری برای همهٔ وسایل نقلیه' },
      { label: 'مدت بیمه‌نامه', value: 'یک‌ساله؛ کوتاه‌مدت هم صادر می‌شود' },
      { label: 'سقف تعهدات مالی', value: 'قابل انتخاب؛ حداقل قانونی تا چند برابر آن' },
      { label: 'تخفیف عدم خسارت', value: 'پلکانی، تا ۷۰٪ در سال چهاردهم' },
      { label: 'جریمه دیرکرد', value: 'روزانه، حداکثر تا ۳۶۵ روز' },
      { label: 'افت قیمت', value: 'تا ۲۰٪ ارزش روز، برای خودروی کمتر از ۱۰ سال' },
    ],
    claimSteps: [
      'در محل حادثه بمانید و در صورت وجود مصدوم با اورژانس و پلیس تماس بگیرید.',
      'کروکی یا گزارش پلیس تهیه کنید؛ در خسارت‌های جزئی و بدون اختلاف، کروکی سازشی کافی است.',
      'بیمه‌نامه، گواهینامه، کارت ملی و کارت خودروی هر دو طرف را آماده کنید.',
      'خسارت را به شرکت بیمه اعلام و پروندهٔ خسارت تشکیل دهید.',
      'خودرو را برای بازدید کارشناس در اختیار بگذارید و فاکتورهای رسمی تعمیر را نگه دارید.',
    ],
    intake: 'SELF_SERVE',
    audience: 'INDIVIDUAL',
    icon: 'Car',
...

  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer: 'اگر بیمه‌نامه بدون خسارت و در همان شرکت تمدید شود، معمولاً بازدید مجدد لازم نیست.',
      },
    ],
    keyFacts: [
      { label: 'اجباری بودن', value: 'اختیاری' },
      { label: 'فرانشیز', value: 'معمولاً ۱۰٪؛ در خسارت سوم به بعد و خودروی فرسوده تا ۳۰٪' },
      { label: 'مهلت اعلام خسارت', value: 'پنج روز کاری' },
      { label: 'پرداخت خسارت', value: 'جزئی تا ۱۵ روز، کلی تا ۶۰ روز' },
      { label: 'محدودیت سن خودرو', value: 'خودروی بالای ۲۰ سال معمولاً بیمه‌پذیر نیست' },
      { label: 'بازدید اولیه', value: 'الزامی، مگر تمدید بدون خسارت در همان شرکت' },
    ],
    claimSteps: [
      'حداکثر تا پنج روز کاری خسارت را به شرکت بیمه اعلام کنید.',
      'کروکی یا گزارش پلیس را در صورت تصادف، و گزارش نیروی انتظامی را در صورت سرقت تهیه کنید.',
      'اصل بیمه‌نامه، کد یکتای شخص ثالث، گواهینامه، کارت ملی و سند مالکیت را ارائه دهید.',
      'خودرو را پیش از هر تعمیری برای بازدید کارشناس ببرید.',
      'پس از تأیید کارشناس تعمیر کنید و فاکتورهای رسمی را برای تسویه ارائه دهید.',
    ],
    intake: 'SELF_SERVE',
    audience: 'INDIVIDUAL',
    icon: 'ShieldCheck',
...

  {
    ...
    keyFacts: [
      { label: 'اجباری بودن', value: 'اجباری' },
      { label: 'مهلت اعلام خسارت', value: 'پنج روز کاری' },
      { label: 'تخفیف عدم خسارت', value: 'پلکانی، تا ۷۰٪' },
      { label: 'جریمه دیرکرد', value: 'روزانه، حداکثر تا ۳۶۵ روز' },
      { label: 'انتقال تخفیف', value: 'فقط به موتور هم‌نوع، برای مالک یا بستگان درجه یک' },
    ],
    claimSteps: [
      'حادثه را حداکثر ظرف پنج روز کاری به شرکت بیمه اعلام کنید.',
      'کروکی یا گزارش پلیس و مدارک هویتی و کارت موتور را آماده کنید.',
      'در خسارت جانی، مدارک پزشکی و گواهی پزشک معالج را ضمیمه کنید.',
      'پروندهٔ خسارت تشکیل دهید و منتظر ارزیابی کارشناس بمانید.',
    ],
    intake: 'SELF_SERVE',
    audience: 'INDIVIDUAL',
    icon: 'Bike',

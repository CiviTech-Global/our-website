  ...
  return [
    {
      ...
      helpEn:
        "The nature of the goods drives the rate — say if they are fragile or perishable.",
    },
...
export const corporateProducts: ProductDef[] = [
...

  {
    ...
    summaryEn:
      "Covers exported goods from your warehouse to the foreign destination",
    description:
...

  {
    ...
    summaryEn:
      "Covers construction and erection projects while they are being built",
    description:

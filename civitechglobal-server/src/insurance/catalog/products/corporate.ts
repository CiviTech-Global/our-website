...
const CARGO_CONDITIONS = [
  { value: 'clause-a', label: 'شرایط A — تمام خطر', labelEn: 'Institute Clauses A — all risks' },
  { value: 'clause-b', label: 'شرایط B', labelEn: 'Institute Clauses B' },
  { value: 'clause-c', label: 'شرایط C — حداقلی', labelEn: 'Institute Clauses C — minimum' },
  { value: 'advise', label: 'نمی‌دانم — راهنمایی می‌خواهم', labelEn: 'Not sure — please advise' },
];

function cargoFields(originLabel: string, originLabelEn: string, destLabel: string, destLabelEn: string): ProductDef['fields'] {
  return [
    {
    ...
    { name: 'origin', label: originLabel, labelEn: originLabelEn, type: 'text', required: true, maxLength: 150 },
    { name: 'destination', label: destLabel, labelEn: destLabelEn, type: 'text', required: true, maxLength: 150 },
    {
...
export const corporateProducts: ProductDef[] = [
  {
    ...
    icon: 'Ship',
    order: 1,
    fields: cargoFields('کشور و بندر مبدأ', 'Country and port of origin', 'مقصد در ایران', 'Destination in Iran'),
  },

  {
    ...
    icon: 'Container',
    order: 2,
    fields: cargoFields('مبدأ در ایران', 'Origin in Iran', 'کشور و بندر مقصد', 'Country and port of destination'),
  },
...

  {
    ...
    fields: [
      ...
      },
      {
        ...
        required: true,
        options: [
          { value: 'car', label: 'تمام خطر پیمانکاران (ساختمانی و عمرانی)', labelEn: 'Contractors all-risk (civil)' },
          { value: 'ear', label: 'تمام خطر نصب (تجهیزات و ماشین‌آلات)', labelEn: 'Erection all-risk (plant)' },

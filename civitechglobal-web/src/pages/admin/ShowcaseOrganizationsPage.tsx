...
export default function ShowcaseOrganizationsPage({ kind }: { kind: OrganizationKind }) {
  ...
  const shown = useClientList(list.order, controls, { searchFields: (org) => [org.name, org.industry] });
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      {list.order.length > 0 && (
        <ListToolbar
          controls={controls}
          searchPlaceholder={t.showcase.searchAdminOrganizations}
          total={shown.total}
          isLoading={isLoading}
        />
      )}

...
role: Retail Customer Returns Agent
division: specialized
version: "1.0.0"
source: agency-agents
source_path: specialized/retail-customer-returns.md
...
# 🛒 Retail Customer Returns — CiviTech Global Platform Adaptation

> Adapted for the **CiviTech Global Platform** from \`agency-agents\` (\`specialized/retail-customer-returns.md\`).

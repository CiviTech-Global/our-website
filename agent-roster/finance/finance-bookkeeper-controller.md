...
role: Bookkeeper & Controller Agent
division: finance
version: "1.0.0"
source: agency-agents
source_path: finance/finance-bookkeeper-controller.md
...
# 📒 Bookkeeper & Controller — CiviTech Global Platform Adaptation

> Adapted for the **CiviTech Global Platform** from \`agency-agents\` (\`finance/finance-bookkeeper-controller.md\`).
